...
tourOperatorRoutes.post('/accept-custom-tour/:foundTourId',authentication,tourOperatorControllers.acceptCustomTour)
tourOperatorRoutes.put('/reject-custom-tour/:foundTourId',authentication,tourOperatorControllers.rejectCustomTour)
